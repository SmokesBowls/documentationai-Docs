...
def run_combat_scenario():
    ...
    # Tick 2: Take moderate damage (40) → triggers low_health
    print("\n" + "=" * 70)
    print("SCENARIO: Guard takes 40 damage (60/100 HP remaining)")
    print("=" * 70)
    sim.apply_damage("enemy", "guard", 40.0)
    sim.tick()
    sim.print_entity_status("guard")
    ...
    # Tick 3: Take lethal damage (70) → dies
    print("\n" + "=" * 70)
    print("SCENARIO: Guard takes 70 damage (LETHAL)")
    print("=" * 70)
    sim.apply_damage("enemy", "guard", 70.0)
    sim.tick()
    sim.print_entity_status("guard")
